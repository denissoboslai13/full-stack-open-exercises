...
const App = () => {
  ...
  return (
    <div>
      ...
      <Content title1={course.parts[0].name} sum1={course.parts[0].exercises} 
              title2={course.parts[1].name} sum2={course.parts[1].exercises}
              title3={course.parts[2].name} sum3={course.parts[2].exercises}
      />
